...
public class SecretaryEndpointTest extends TestBase {
    ...
    public void givenCreateSecretaryDetailDtoWithEmptyEmail_whenCreateNewSecretary_thenReturn422UnprocessableEntityStatus() throws Exception {
        String json = ow.writeValueAsString(new SecretaryDtoCreate("", "a", "b"));
        mockMvc
            .perform(MockMvcRequestBuilders
                .post(BASE_PATH).contentType(MediaType.APPLICATION_JSON).content(json)
                .accept(MediaType.APPLICATION_JSON))
        ...
        List<SecretaryDtoDetail> secretaryResult = objectMapper.readerFor(SecretaryDtoDetail.class)
            .<SecretaryDtoDetail>readValues(body).readAll();
    ...
    @Test
    @WithMockUser(username = "admin", authorities = {"ADMIN"})
    public void givenCreateSecretaryDetailDtoWithNullEmail_whenCreateNewSecretary_thenReturn422UnprocessableEntityStatus() throws Exception {
        String json = ow.writeValueAsString(new SecretaryDtoCreate(null, "a", "b"));
        mockMvc
            .perform(MockMvcRequestBuilders
                .post(BASE_PATH).contentType(MediaType.APPLICATION_JSON).content(json)
                .accept(MediaType.APPLICATION_JSON))
    ...
    @Test
    @WithMockUser(username = "admin", authorities = {"ADMIN"})
    public void givenCreateSecretaryDetailDtoWithEmptyFirstName_whenCreateNewSecretary_thenReturn422UnprocessableEntityStatus() throws Exception {
        String json = ow.writeValueAsString(new SecretaryDtoCreate("a.a@a.a", "", "b"));
        mockMvc
            .perform(MockMvcRequestBuilders
                .post(BASE_PATH).contentType(MediaType.APPLICATION_JSON).content(json)
    ...
    @Test
    @WithMockUser(username = "admin", authorities = {"ADMIN"})
    public void givenCreateSecretaryDetailDtoWithNullFirstName_whenCreateNewSecretary_thenReturn422UnprocessableEntityStatus() throws Exception {
        String json = ow.writeValueAsString(new SecretaryDtoCreate("a.a@a.a", null, "b"));
        mockMvc
            .perform(MockMvcRequestBuilders
                .post(BASE_PATH).contentType(MediaType.APPLICATION_JSON).content(json)
                .accept(MediaType.APPLICATION_JSON))
    ...
    @Test
    @WithMockUser(username = "admin", authorities = {"ADMIN"})
    public void givenCreateSecretaryDetailDtoWithEmptyLastName_whenCreateNewSecretary_thenReturn422UnprocessableEntityStatus() throws Exception {
        String json = ow.writeValueAsString(new SecretaryDtoCreate("a.a@a.a", "a", ""));
        mockMvc
            .perform(MockMvcRequestBuilders
                .post(BASE_PATH).contentType(MediaType.APPLICATION_JSON).content(json)
                .accept(MediaType.APPLICATION_JSON))
    ...
    @Test
    @WithMockUser(username = "admin", authorities = {"ADMIN"})
    public void givenCreateSecretaryDetailDtoWithNullLastName_whenCreateNewSecretary_thenReturn422UnprocessableEntityStatus() throws Exception {
        String json = ow.writeValueAsString(new SecretaryDtoCreate("a.a@a.a", "a", null));
        mockMvc
            .perform(MockMvcRequestBuilders
                .post(BASE_PATH).contentType(MediaType.APPLICATION_JSON).content(json)
                .accept(MediaType.APPLICATION_JSON))
    ...
    @Test
    @WithMockUser(username = "admin", authorities = {"ADMIN"})
    public void givenCreateSecretaryDetailDtoWithTooLongLastName_whenCreateNewSecretary_thenReturn422UnprocessableEntityStatus() throws Exception {
        String json = ow.writeValueAsString(new SecretaryDtoCreate("a.a@a.a", "a",
    ...
    @Test
    @WithMockUser(username = "admin", authorities = {"ADMIN"})
    public void givenInvalidId_whenGetSecretary_thenReturn404NotFoundStatus() throws Exception {
        mockMvc
