...
public class AdministratorEndpointTest extends TestBase {
    @Autowired
    ...
    public AdministratorEndpointTest() {
        super("administrator");
    }
    ...
    @Test
    @WithMockUser(username = "admin", authorities = {"ADMIN"})
    public void givenValidCreateAdministratorDetailDto_whenCreateNewAdministrator_thenReturn201CreatedStatusAndCreatedAdministrator() throws Exception {
        String json = ow.writeValueAsString(new AdministratorDtoCreate("a.a@a.a", "a", "b"));
        mockMvc
            .perform(MockMvcRequestBuilders
        ...
        List<Credential> credentials = administratorRepository.findAllAdministratorCredentials();
    ...
    public void givenWrongAuthority_whenCreateAdministrator_thenReturnForbiddenStatus() throws Exception {
        String json = ow.writeValueAsString(new AdministratorDtoCreate("a@a.a", "a", "b"));
    ...
    @Test
    @WithMockUser(username = "admin", authorities = {"ADMIN"})
    public void givenCreateAdministratorDetailDtoWithEmptyEmail_whenCreateNewAdministrator_thenReturn422UnprocessableEntityStatus() throws Exception {
        String json = ow.writeValueAsString(new AdministratorDtoCreate("", "a", "b"));
        mockMvc
            .perform(MockMvcRequestBuilders
                .post(BASE_PATH).contentType(MediaType.APPLICATION_JSON).content(json)
                .accept(MediaType.APPLICATION_JSON))
        ...
        List<AdministratorDtoDetail> AdministratorResult = objectMapper.readerFor(AdministratorDtoDetail.class)
            .<AdministratorDtoDetail>readValues(body).readAll();

        assertThat(AdministratorResult)
            .hasSize(0);
    ...
    @Test
    @WithMockUser(username = "admin", authorities = {"ADMIN"})
    public void givenCreateAdministratorDetailDtoWithNullEmail_whenCreateNewAdministrator_thenReturn422UnprocessableEntityStatus() throws Exception {
        String json = ow.writeValueAsString(new AdministratorDtoCreate(null, "a", "b"));
        mockMvc
            .perform(MockMvcRequestBuilders
                .post(BASE_PATH).contentType(MediaType.APPLICATION_JSON).content(json)
                .accept(MediaType.APPLICATION_JSON))
    ...
    @Test
    @WithMockUser(username = "admin", authorities = {"ADMIN"})
    public void givenCreateAdministratorDetailDtoWithEmptyFirstName_whenCreateNewAdministrator_thenReturn422UnprocessableEntityStatus() throws Exception {
        String json = ow.writeValueAsString(new AdministratorDtoCreate("a.a@a.a", "", "b"));
        mockMvc
            .perform(MockMvcRequestBuilders
                .post(BASE_PATH).contentType(MediaType.APPLICATION_JSON).content(json)
    ...
    @Test
    @WithMockUser(username = "admin", authorities = {"ADMIN"})
    public void givenCreateAdministratorDetailDtoWithNullFirstName_whenCreateNewAdministrator_thenReturn422UnprocessableEntityStatus() throws Exception {
        String json = ow.writeValueAsString(new AdministratorDtoCreate("a.a@a.a", null, "b"));
        mockMvc
            .perform(MockMvcRequestBuilders
                .post(BASE_PATH).contentType(MediaType.APPLICATION_JSON).content(json)
                .accept(MediaType.APPLICATION_JSON))
    ...
    @Test
    @WithMockUser(username = "admin", authorities = {"ADMIN"})
    public void givenCreateAdministratorDetailDtoWithEmptyLastName_whenCreateNewAdministrator_thenReturn422UnprocessableEntityStatus() throws Exception {
        String json = ow.writeValueAsString(new AdministratorDtoCreate("a.a@a.a", "a", ""));
        mockMvc
            .perform(MockMvcRequestBuilders
                .post(BASE_PATH).contentType(MediaType.APPLICATION_JSON).content(json)
                .accept(MediaType.APPLICATION_JSON))
    ...
    @Test
    @WithMockUser(username = "admin", authorities = {"ADMIN"})
    public void givenCreateAdministratorDetailDtoWithNullLastName_whenCreateNewAdministrator_thenReturn422UnprocessableEntityStatus() throws Exception {
        String json = ow.writeValueAsString(new AdministratorDtoCreate("a.a@a.a", "a", null));
        mockMvc
            .perform(MockMvcRequestBuilders
                .post(BASE_PATH).contentType(MediaType.APPLICATION_JSON).content(json)
                .accept(MediaType.APPLICATION_JSON))
    ...
    @Test
    @WithMockUser(username = "admin", authorities = {"ADMIN"})
    public void givenValidCreateAdministratorDetailDtoWithAlreadyExistingEmail_whenCreateNewAdministrator_thenReturns409Conflict() throws Exception {
        String json = ow.writeValueAsString(new AdministratorDtoCreate("a.a@a.a", "a", "b"));
    ...
    @Test
    @WithMockUser(username = "admin", authorities = {"ADMIN"})
    public void givenIdOfAdministrator_whenGetAdministrator_thenReturnAdministrator() throws Exception {
        byte[] bodyGet = mockMvc.perform(MockMvcRequestBuilders.get(BASE_PATH + "/" + administratorRepository.findAll().get(0).getAdministratorId())
                .accept(MediaType.APPLICATION_JSON))
            .andExpect(status().isOk())
            .andReturn().getResponse().getContentAsByteArray();
        List<AdministratorDto> AdministratorGet = objectMapper.readerFor(AdministratorDto.class).<AdministratorDto>readValues(bodyGet).readAll();
        assertNotNull(AdministratorGet);
        assertThat(AdministratorGet).extracting(AdministratorDto::email, AdministratorDto::firstname, AdministratorDto::lastname).contains(
            AssertionsForClassTypes.tuple("administrator1@email.com", "Administrator", "One"));
    }

    @Transactional
    @Test
    @WithMockUser(username = "patient", authorities = {"PATIENT"})
    public void givenIdOfAdministrator_whenGetAdministratorWithWrongAuthority_thenReturnForbiddenStatus() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(BASE_PATH + "/" + administratorRepository.findAll().get(0).getAdministratorId())
                .accept(MediaType.APPLICATION_JSON))
            .andExpect(status().isForbidden());
    }
    ...
    @Test
    @WithMockUser(username = "admin", authorities = {"ADMIN"})
    public void givenInvalidId_whenGetAdministrator_thenReturn404NotFoundStatus() throws Exception {
        mockMvc
    ...
    @Test
    @WithMockUser(username = "admin", authorities = {"ADMIN"})
    public void givenNoMatchingAdministrator_whenGetAdministratorWithNoId_thenReturns404NotFound() throws Exception {
    ...
    @Test
    @WithMockUser(username = "admin", authorities = {"ADMIN"})
    public void givenNoMatchingAdministrator_whenGetAdministratorWithInvalidId_thenReturns400BadRequest() throws Exception {
    ...
    @Test
    @WithMockUser(username = "admin", authorities = {"ADMIN"})
    public void givenNoAdministratorInDatabase_whenGetAllAdministrators_thenReturnsEmptyList() throws Exception {
        administratorRepository.deleteAll();
        byte[] bodyGet = mockMvc.perform(MockMvcRequestBuilders.get(BASE_PATH)
                .accept(MediaType.APPLICATION_JSON))
            .andExpect(status().isOk())
            .andReturn().getResponse().getContentAsByteArray();
        List<AdministratorDto> administrators = objectMapper.readerFor(AdministratorDto.class).<AdministratorDto>readValues(bodyGet).readAll();
        assertThat(administrators).isEmpty();
    }

    @Transactional
    @Test
    @WithMockUser(username = "admin", authorities = {"ADMIN"})
    public void givenThreeCreatedAdministrators_whenGetAllAdministrators_thenReturnsThreeAdministrators() throws Exception {
        administratorRepository.deleteAll();
        String json1 = ow.writeValueAsString(new AdministratorDtoCreate("a@a.a", "a", "b"));
        mockMvc.perform(MockMvcRequestBuilders.post(BASE_PATH)
                .contentType(MediaType.APPLICATION_JSON)
                .content(json1)
                .accept(MediaType.APPLICATION_JSON))
        ...
        String json2 = ow.writeValueAsString(new AdministratorDtoCreate("b@b.b", "a", "b"));
        mockMvc.perform(MockMvcRequestBuilders.post(BASE_PATH)
                .contentType(MediaType.APPLICATION_JSON)
                .content(json2)
                .accept(MediaType.APPLICATION_JSON))
        ...
        String json3 = ow.writeValueAsString(new AdministratorDtoCreate("c@c.c", "a", "b"));
        mockMvc.perform(MockMvcRequestBuilders.post(BASE_PATH)
                .contentType(MediaType.APPLICATION_JSON)
                .content(json3)
                .accept(MediaType.APPLICATION_JSON))
        ...
        Credential Administrator1 = credentials.get(0);
        Credential Administrator2 = credentials.get(1);
        Credential Administrator3 = credentials.get(2);

        byte[] bodyGet = mockMvc.perform(MockMvcRequestBuilders.get(BASE_PATH)
                .accept(MediaType.APPLICATION_JSON))
            .andExpect(status().isOk())
            .andReturn().getResponse().getContentAsByteArray();
        List<UserLoginDto> administrators = objectMapper.readerFor(UserLoginDto.class).<UserLoginDto>readValues(bodyGet).readAll();
        assertThat(administrators).hasSize(3)
            .extracting(UserLoginDto::getEmail).containsExactlyInAnyOrder(
                Administrator1.getEmail(),
                Administrator2.getEmail(),
                Administrator3.getEmail());
    }

    @Transactional
    @Test
    @WithMockUser(username = "admin", authorities = {"ADMIN"})
    public void givenNonExistentId_whenUpdateAdministrator_thenReturns404NotFound() throws Exception {
        String json = ow.writeValueAsString(new AdministratorDtoUpdate("Updated", "Administrator", "updated@email.com", false, true));
    ...
    @Test
    @WithMockUser(username = "admin", authorities = {"ADMIN"})
    public void givenAdministratorDtoUpdate_whenUpdateAdministrator_thenAdministratorGetsUpdatedAndNowHasUpdatedData() throws Exception {
        ...
        byte[] bodyUpdate = mockMvc.perform(MockMvcRequestBuilders.put(BASE_PATH + "/" + id)
            ...
            .andExpect(status().isOk())
            .andReturn().getResponse().getContentAsByteArray();
        administratorGet = objectMapper.readerFor(AdministratorDto.class).<AdministratorDto>readValues(bodyUpdate).readAll();
        assertThat(administratorGet).extracting(AdministratorDto::email, AdministratorDto::firstname, AdministratorDto::lastname).contains(
            AssertionsForClassTypes.tuple("updated@email.com", "Updated", "Administrator"));

        bodyGet = mockMvc.perform(MockMvcRequestBuilders.get(BASE_PATH + "/" + id)
                .accept(MediaType.APPLICATION_JSON))
            .andExpect(status().isOk())
            .andReturn().getResponse().getContentAsByteArray();
        administratorGet = objectMapper.readerFor(AdministratorDto.class).<AdministratorDto>readValues(bodyGet).readAll();
        assertThat(administratorGet).extracting(AdministratorDto::email, AdministratorDto::firstname, AdministratorDto::lastname).contains(
            AssertionsForClassTypes.tuple("updated@email.com", "Updated", "Administrator"));
    }
    ...
    public void givenWrongAuthority_whenUpdateAdministrator_thenReturnForbiddenStatus() throws Exception {
        String json = ow.writeValueAsString(new AdministratorDtoUpdate("Updated", "Administrator", "updated@email.com", false, true));
        mockMvc.perform(MockMvcRequestBuilders.put(BASE_PATH + "/1")
                .contentType(MediaType.APPLICATION_JSON)
                .content(json)
    ...
    @Test
    @WithMockUser(username = "admin", authorities = {"ADMIN"})
    public void givenUserDtoSearch_whenSearchAdministrators_thenReturnListOfMatchingAdministrators() throws Exception {
        byte[] body = mockMvc.perform(MockMvcRequestBuilders.get(BASE_PATH + "/search")
                .queryParam("email", "administrator1@email.com")
                .queryParam("firstName", "Administrator")
                .queryParam("lastName", "One")
                .accept(MediaType.APPLICATION_JSON))
            .andExpect(status().isOk())
            .andReturn().getResponse().getContentAsByteArray();

        List<AdministratorDto> administrators = objectMapper.readerFor(AdministratorDto.class).<AdministratorDto>readValues(body).readAll();
        assertThat(administrators).hasSize(1)
            .extracting(AdministratorDto::email, AdministratorDto::firstname, AdministratorDto::lastname).contains(
                AssertionsForClassTypes.tuple("administrator1@email.com", "Administrator", "One"));
    }
    ...
    @Test
    @WithMockUser(username = "admin", authorities = {"ADMIN"})
    public void givenNonExistentUserDtoSearch_whenSearchAdministrators_thenReturnEmptyList() throws Exception {
        byte[] body = mockMvc.perform(MockMvcRequestBuilders.get(BASE_PATH + "/search")
                .queryParam("email", "Administrator-1@email.com")
                .accept(MediaType.APPLICATION_JSON))
            .andExpect(status().isOk())
            .andReturn().getResponse().getContentAsByteArray();

        List<AdministratorDto> administrators = objectMapper.readerFor(AdministratorDto.class).<AdministratorDto>readValues(body).readAll();
        assertThat(administrators).hasSize(0);
    }

    @Transactional
    @Test
    @WithMockUser(username = "admin", authorities = {"PATIENT"})
    public void givenWrongAuthority_whenSearchAdministrators_thenReturnForbiddenStatus() throws Exception {
